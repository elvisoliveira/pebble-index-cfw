/* Custom Server 1 (CUSTS1) profile database definitions (from the Dialog SDK template). */
...
#define DEF_SVC1_CTRL_POINT_CHAR_LEN     48   /* the pairing answer is 33 bytes: opcode + key */
